...
namespace XoopsModules\Wggallery\Form;
...
class FormInline extends XoopsSimpleForm
{
    ...
    {
        $ret = $this->getTitle() . "\n<form name='" . $this->getName() . "' id='" . $this->getName() . "' action='" . $this->getAction() . "' style='display:inline;' method='" . $this->getMethod() . "'" . $this->getExtra() . ">\n";
