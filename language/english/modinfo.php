...
\define('_MI_WGGALLERY_SMNAME7', 'Upload single image');
// Blocks
...
\define('_MI_WGGALLERY_IDX_ALBLIST', 'Show album list on index');
\define('_MI_WGGALLERY_IDX_ALBLIST_DESC', 'Define whether you want to show an album list on index page and which type');
\define('_MI_WGGALLERY_IDX_ALBLIST_NONE', 'No List');
\define('_MI_WGGALLERY_IDX_ALBLIST_LIST', 'List only');
\define('_MI_WGGALLERY_IDX_ALBLIST_LISTTHUMB', 'List with thumbs');
\define('_MI_WGGALLERY_UPLOADER', 'Upload possibilities');
\define('_MI_WGGALLERY_UPLOADER_DESC', 'Define which possibilities for upload you want to use');
\define('_MI_WGGALLERY_UPLOADER_NONE', 'No upload feature on user side');
\define('_MI_WGGALLERY_UPLOADER_MULTI', 'Use multi upload only');
...
/*version 1.2.3*/
\define('_MI_WGGALLERY_IMAGE_NAME', 'Image name for fild upload');
